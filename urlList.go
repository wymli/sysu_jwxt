...
func (list *urlList) init(mode string) {
	if mode == "webvpn" {
	...
	list.getPublicCoursejsonBody = `{"pageNo":1,"pageSize":10,"param":{"semesterYear":"2019-2","selectedType":"4","selectedCate":"11","hiddenConflictStatus":"0","hiddenSelectedStatus":"0","collectionStatus":"0","studyCampusId":"5063559"}}`
	list.getTeachersInfojsonBody = `{"pageNo":1,"pageSize":20,"total":true,"param":{"acadYear":"2019-1"}}`
	// 专选
	list.getMajorOptionaljsonBody = `{"pageNo":1,"pageSize":10,"param":{"semesterYear":"2019-2","selectedType":"1","selectedCate":"21","hiddenConflictStatus":"0","hiddenSelectedStatus":"0","collectionStatus":"0"}}`
